...
#
OBJS = server.o request.o segel.o client.o threadpool.o
TARGET = server
...
server: server.o threadpool.o request.o segel.o
	$(CC) $(CFLAGS) -o server server.o threadpool.o request.o segel.o $(LIBS)
